...
class ModxChargifySubscription extends ChargifySubscription {

    private $connector;

    public function __construct(modX &$modx, SimpleXMLElement $subscription_xml_node = null, $test_mode = false) {
        $this->modx = & $modx;
        $this->connector = new ModxChargifyConnector($this->modx, $test_mode);
